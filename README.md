## Este repositório contém uma API REST simples desenvolvida com o framework Django REST. O projeto tem como objetivo fornecer uma introdução prática ao desenvolvimento de APIs REST utilizando o Django.
